...
#define LCD_PIN_RS_PORT   GPIOC
#define LCD_PIN_RS        GPIO_PIN_0

#define LCD_PIN_RW_PORT   GPIOC
#define LCD_PIN_RW        GPIO_PIN_2

#define LCD_PIN_EN_PORT   GPIOA
#define LCD_PIN_EN        GPIO_PIN_0

#define LCD_PIN_D4_PORT   GPIOC
#define LCD_PIN_D4        GPIO_PIN_1

#define LCD_PIN_D5_PORT   GPIOC
#define LCD_PIN_D5        GPIO_PIN_3

#define LCD_PIN_D6_PORT   GPIOA
#define LCD_PIN_D6        GPIO_PIN_1
